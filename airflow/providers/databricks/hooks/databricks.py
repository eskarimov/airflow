...
class RunState:
    ...
    @classmethod
    def from_json(cls, data) -> 'RunState':
...
class DatabricksAsyncHook(DatabricksHook):
    ...
    Implements only necessary methods used further
    in :func:`airflow.providers.databricks.triggers.DatabricksExecutionTrigger.run`
    """
